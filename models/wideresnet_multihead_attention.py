...
class WideResNet_mh(nn.Module):
    def __init__(self, args, num_classes):
        super(WideResNet_mh, self).__init__()
        depth = args.layers
        ...
        self.attn = attention(self.nChannels[3])
    ...
    def forward(self, x):
        ...
        pool_size = out.size(2)  # Adapt pool size to the size of the feature dimension
